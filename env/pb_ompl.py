...
class PbOMPL():
    ...
    def plan_start_goal(self, start, goal, allowed_time = DEFAULT_PLANNING_TIME, interpolate=False):
    ...
    def plan(self, goal, allowed_time = DEFAULT_PLANNING_TIME, interpolate=False):
        ...
        return self.plan_start_goal(start, goal, allowed_time=allowed_time, interpolate=interpolate)
